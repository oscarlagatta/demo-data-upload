...
import { useTransactionUsWiresSearch } from "@/src/domains/payment-health/hooks/use-get-splunk-us-wires/use-transaction-us-wires-search"
import type { SplunkTransactionDetails } from "@/src/domains/payment-health/types/splunk-transaction"
import type { ApiError } from "@/src/domains/payment-health/types/api-error"
...
const TransactionUsWiresSearchContext = createContext<TransactionUsWiresSearchContextValue | null>(null)
...
export function TransactionUsWiresSearchProvider({
  ...
  return <TransactionUsWiresSearchContext.Provider value={value}>{children}</TransactionUsWiresSearchContext.Provider>
}
